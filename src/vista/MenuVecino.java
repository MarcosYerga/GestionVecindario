...
/**
 * Clase que sirve para visualizar la interfaz del menu de vecino
 * @author Marcos Yerga Gomez
 */
public class MenuVecino extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(botonServicios, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE)
    ...
    private void botonUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonUsuarioActionPerformed
        dispose();
        new SubMenuUsuariosVec().setVisible(true);
    ...
    private void botonServiciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonServiciosActionPerformed
        dispose();
        new SubMenuServiciosVec().setVisible(true);
    ...
    private void botonLiquidacionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonLiquidacionesActionPerformed
        dispose();
        new SubMenuLiquidacionesVec().setVisible(true);
